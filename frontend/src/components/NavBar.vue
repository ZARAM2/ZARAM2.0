  ...
  <div>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      ...
      <div class="container px-4 px-lg-5">
        <router-link to="/home"><img id="logo" class="navbar-brand" src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/fd/Zara_Logo.svg/2560px-Zara_Logo.svg.png" alt="zara" style="cursor: pointer" /></router-link>
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ms-auto">
            ...
            <li v-if="currentUser" class="nav-item">
              <router-link class="nav-link" to="/login"  @click="Login">LOG IN</router-link>
            </li>
            <li v-if="currentUser" class="nav-item">
